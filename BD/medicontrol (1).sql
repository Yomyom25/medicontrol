...
--
-- Estructura de tabla para la tabla `notas_consulta`
--
...
CREATE TABLE `reportes` (
  ...
  `tipo` enum('citas','ocupacion') NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `tipo` enum('administrativo','medico','paciente') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `notas_consulta`
--
ALTER TABLE `notas_consulta`
...
ALTER TABLE `reportes`
  ...
  ADD KEY `fk_reportes_medico` (`id_medico`);
...
--
-- AUTO_INCREMENT de la tabla `notas_consulta`
--
ALTER TABLE `notas_consulta`
...
--
-- Filtros para la tabla `notas_consulta`
--
ALTER TABLE `notas_consulta`
  ADD CONSTRAINT `notas_consulta_ibfk_1` FOREIGN KEY (`id_cita`) REFERENCES `citas` (`id_cita`) ON DELETE CASCADE;
...
--
ALTER TABLE `reportes`
  ADD CONSTRAINT `fk_reportes_medico` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_medico`) ON DELETE CASCADE;
COMMIT;
